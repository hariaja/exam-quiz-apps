...
<div class="block block-rounded">
  ...
  <div class="block-content block-content-full">
    ...
    <form action="{{ route('categories.store') }}" method="POST" onsubmit="return disableSubmitButton()">
      @csrf
      ...
      <div class="row justify-content-center">
        <div class="col-md-6">
          ...
          <div class="mb-4">
            ...
            <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="{{ trans('etc. Hafalan') }}" onkeypress="return onlyLetter(event)">
            @error('name')
